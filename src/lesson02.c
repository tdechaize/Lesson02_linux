/*
=====================================================================
OpenGL Lesson 02 :  Creating Another OpenGL Window with glut on Linux
=====================================================================
...
* \brief           Ouvre une simple fenêtre Wayland on Linux et dessine deux formes simples : un triangle et un carré blancs avec OpenGL + glut.
...
/**	            This function inform caller what key is pressed.
*
...
/**	            This Code initialize into glut the dimensions (width & height) of the window into screen.
*
...
* \param	  X			    le positionnement de la fenêtre en x dans l'écran
* \param	  Y			    le positionnement de la fenêtre en y dans l'écran
* \return     void          aucun retour de fonction.
*
*/
...
*/
  ...
  window = glutCreateWindow("Jeff Molofee's GL Code Tutorial ... Draw white triangle and square - NeHe '99");
...
* \details    EAucun paramètre en entrée ni en sortie.
* \return     void          aucun retour de fonction.
*
*/
