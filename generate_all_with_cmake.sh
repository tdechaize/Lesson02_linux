...
function gengcc32() {
rm CMakeLists.txt
rm build.cmake/gcc32/Debug/CMakeCache.txt
rm build.cmake/gcc32/Release/CMakeCache.txt
...
function gengcc64() {
rm CMakeLists.txt
rm build.cmake/gcc64/Debug/CMakeCache.txt
rm build.cmake/gcc64/Release/CMakeCache.txt
...
function genclang32() {
rm CMakeLists.txt
rm build.cmake/clang32/Debug/CMakeCache.txt
rm build.cmake/clang32/Release/CMakeCache.txt
...
function genclang64() {
rm CMakeLists.txt
rm build.cmake/clang64/Debug/CMakeCache.txt
rm build.cmake/clang64/Release/CMakeCache.txt
